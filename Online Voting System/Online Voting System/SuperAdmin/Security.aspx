<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master Page/SuperAdminMaster.Master" CodeBehind="Security.aspx.cs" Inherits="Online_Voting_System.SuperAdmin.Security" %>

<asp:Content ID="security_head" ContentPlaceHolderID="superAdminHead" runat="server">

</asp:Content>

<asp:Content ID="security_body" ContentPlaceHolderID="superAdminBody" runat="server">   
    <asp:Label ID="lblSecurity" runat="server" ForeColor="#FF0066"></asp:Label>
    <center>
        <table width="100%">
            <tr>
                <td align="left">
